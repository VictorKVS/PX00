...
- [`architecture/adr/ADR-0010-authority-gated-execution-and-trace-contracts.md`](architecture/adr/ADR-0010-authority-gated-execution-and-trace-contracts.md) and [`architecture/adr/ADR-0011-knowledge-admission-and-decision-evaluation.md`](architecture/adr/ADR-0011-knowledge-admission-and-decision-evaluation.md) — current baseline decisions.
...
- [`Tree_F/TF-0003_2026-08-11_CANONICAL_OBJECT_AND_ROLE_CONTRACTS.md`](Tree_F/TF-0003_2026-08-11_CANONICAL_OBJECT_AND_ROLE_CONTRACTS.md) — object/role contract generation.
- [`Tree_F/TF-0004_2026-08-11_AUTHORITY_AND_TRACE_CONTRACTS.md`](Tree_F/TF-0004_2026-08-11_AUTHORITY_AND_TRACE_CONTRACTS.md) — authority/trace contract generation.
- [`Tree_F/TF-0005_2026-08-11_KNOWLEDGE_AND_DECISION_EVALUATION.md`](Tree_F/TF-0005_2026-08-11_KNOWLEDGE_AND_DECISION_EVALUATION.md) — knowledge/evaluation contract generation.
...
`Architecture Baseline 0.1` — contract and governance definition only. Runtime code remains blocked until Protocol Execution, Acceptance Model and first governed Role Package pilots validate the contracts.
