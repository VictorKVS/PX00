...
The first CI execution after introducing this generation showed all new governed-action validator unit tests passing. Repository integration failed only because this work initially reused already occupied `Tree_F` sequence numbers. The records were therefore renumbered to the next free sequence (`TF-0023..TF-0025`) rather than weakening the sequence validator.
...
1. Confirm CI passes after Tree_F renumbering.
2. Preserve PASS evidence.
